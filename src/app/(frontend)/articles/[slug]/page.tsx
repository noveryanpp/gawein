...
import { getArticlePostData } from '@/lib/payload'
      ...
      <section className="pt-24 pb-8 bg-gradient-to-br from-[#FAFAFA] via-[#E6F2FF] to-[#FAFAFA] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="relative mb-8">
            ...
            <div className="flex flex-col mb-8 p-6 bg-[#FAFAFA]/90 backdrop-blur-sm border border-[#E6F2FF] rounded-2xl max-w-6xl mx-auto -mt-16 shadow-lg">
              <div className="flex flex-wrap items-center gap-4 mb-4">
              <span className="px-3 py-1 bg-gradient-to-r from-[#2EBEFA] to-[#0057B8] text-white text-sm font-semibold rounded-full">
                {categoryLabel}
              </span>
                  ...
                  <article className="bg-[#FAFAFA]/80 backdrop-blur-sm border border-[#E6F2FF] rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-500 hover:scale-105">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs text-gray-500">{article.readingTime ? `${article.readingTime} min` : ''}</span>
                      </div>
                    </div>
                  </article>
                </Link>
