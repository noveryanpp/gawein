  ...
  const faqs = [
    {
      ...
      answer:
        'Durasi proyek tergantung pada tingkat kompleksitas dan ruang lingkupnya. Website sederhana biasanya selesai dalam 2-4 minggu, sedangkan aplikasi web kompleks bisa memakan waktu 2-4 bulan. Kami akan memberikan estimasi waktu detail saat konsultasi awal.',
    },
    {
      question: 'Apakah Gawein menyediakan dukungan dan maintenance berkelanjutan?',
      answer:
        'Tentu! Kami menawarkan paket dukungan dan maintenance lengkap, termasuk update keamanan, monitoring performa, perbaikan bug, dan penambahan fitur. Dukungan kami tersedia 24/7 untuk masalah kritis.',
    },
    {
      question: 'Apakah saya bisa request fitur khusus sesuai kebutuhan bisnis?',
      answer:
        'Bisa banget! Kami selalu menyesuaikan solusi dengan kebutuhan unik bisnismu. Silakan diskusikan ide dan fitur yang kamu inginkan saat konsultasi, dan tim kami akan membantu mewujudkannya.',
    },
    {
      question: 'Bagaimana proses kerja sama dengan Gawein?',
      answer:
        'Prosesnya mudah! Mulai dari konsultasi, penentuan kebutuhan, pembuatan proposal, pengembangan, hingga revisi dan peluncuran. Kami selalu update progres secara transparan dan komunikatif.',
    },
    {
      question: 'Apakah harga yang ditawarkan sudah termasuk revisi?',
      answer:
        'Ya, harga yang kami tawarkan sudah termasuk revisi sesuai kesepakatan awal. Kami ingin memastikan hasil akhir benar-benar sesuai harapanmu.',
    },
  ]
