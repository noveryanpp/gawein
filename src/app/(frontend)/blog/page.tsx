  ...
  const blogPosts = [
    {
      ...
      excerpt: "Panduan lengkap memilih framework JavaScript yang tepat untuk kebutuhan proyekmu. Dari React hingga Vue, temukan yang paling cocok!",
    ...
    },
    {
      ...
      excerpt: "Tren desain terbaru yang akan mendominasi tahun 2024. Mulai dari minimalism hingga bold colors, semuanya ada di sini!",
    ...
    },
    {
      ...
      excerpt: "Strategi jitu meningkatkan performa website dan ranking SEO. Tips praktis yang bisa langsung kamu terapkan hari ini!",
    ...
    },
    {
      ...
      excerpt: "Tutorial step-by-step membuat RESTful API yang robust dengan Node.js. Cocok untuk pemula hingga developer berpengalaman!",
    ...
    },
    {
      ...
      excerpt: "Perbandingan lengkap antara native dan cross-platform development. Mana yang lebih cocok untuk proyekmu?",
    ...
    },
    {
      ...
      excerpt: "Tips dan strategi penting untuk menjaga keamanan website dan aplikasi web dari berbagai ancaman cyber.",
      content: "Artikel lengkap tentang web security...",
      author: "Maya Sari",
      authorAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80",
    ...
    },
    {
      ...
      excerpt: "Pelajari cara menggunakan Docker dan Kubernetes untuk deployment aplikasi yang lebih efisien dan skalabel.",
    ...
    },
    {
      ...
      excerpt: "Kenali teknologi PWA dan bagaimana cara membuatnya. Solusi terbaik untuk pengalaman mobile yang seamless!",
      ...
      <section className="pt-24 pb-16 bg-gradient-to-br from-[#FAFAFA] via-[#E6F2FF] to-[#FAFAFA] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Temukan artikel, tutorial, dan insights terbaru seputar teknologi, design, dan development
            yang bisa bantu kamu berkembang di dunia digital.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {currentBlogs.length > 0 ? (
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {blog.tags.slice(0, 2).map((tag, index) => (
                          <span key={index} className="px-2 py-1 bg-[#E6F2FF] text-[#0057B8] text-xs font-medium rounded-md">
                            {tag}
                          </span>
                        ))}
                        {blog.tags.length > 2 && (
                          <span className="text-xs text-gray-500">+{blog.tags.length - 2} lainnya</span>
                        )}
                      </div>
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-6">Coba ganti kata kunci atau pilih kategori yang berbeda.</p>
              <Button
                variant="outline"
