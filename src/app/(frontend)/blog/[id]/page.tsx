...
const BlogPostContent = () => {
  ...
  // Dummy blog data (in real app, this would come from API or database)
  const blogPosts = [
    {
      id: 1,
      ...
      authorBio: "Senior Full-Stack Developer dengan 8+ tahun pengalaman dalam JavaScript dan teknologi web modern. Suka berbagi ilmu melalui artikel dan workshop.",
    ...
    },
    {
      ...
      authorBio: "UI/UX Designer dengan passion untuk menciptakan pengalaman pengguna yang meaningful. Berpengalaman 6+ tahun di berbagai industri.",
  ...
  // Get other related blogs (same category, excluding current)
    ...
    return (
      <div className="pt-24 pb-16 text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-gray-600 mb-8">Maaf, artikel yang kamu cari tidak ada atau sudah dihapus.</p>
          <Link href="/blog">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <nav className="mb-8">
            <div className="flex items-center space-x-2 text-sm text-gray-500">
              ...
              <span>/</span>
              <Link href="/blog" className="hover:text-[#1E90FF] transition-colors">Blog</Link>
              <span>/</span>
