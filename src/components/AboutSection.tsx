          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Di Gawein, kami antusias mengubah ide-ide inovatif jadi solusi digital yang
                bermanfaat. Tim developer, desainer, dan strategis kami siap berkolaborasi untuk
                menghadirkan teknologi terkini yang bikin bisnismu makin berkembang.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Setiap proyek kami selalu melalui pengujian ketat dan perhatian pada detail.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-[#FAFAFA] to-[#E6F2FF] rounded-2xl p-6 backdrop-blur-sm border border-[#E6F2FF]">
                  ...
                  <p className="text-sm text-gray-600">
                    Web-mu sudah pasti aman dari hacker nakal!
                  </p>
                </div>
              </div>
            </div>
