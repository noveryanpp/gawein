...
import { HomePageData } from '@/lib/payload'
        ...
        <div className="text-center text-white">
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <p className="text-lg sm:text-xl text-[#E6F2FF] leading-relaxed">
              Yuk kolaborasi bareng kami untuk mewujudkan ide kamu jadi solusi teknologi yang keren
              dan bermanfaat. Tim kami siap bantu bisnismu tampil maksimal di dunia digital!
            </p>
