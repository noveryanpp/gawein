...
export const ServicesSection = () => {
  const services = [
    {
      ...
      description:
        'Website dan aplikasi web custom dengan framework modern seperti React, Next.js, dan Node.js untuk performa maksimal.',
    ...
    },
    {
      ...
      description:
        'Solusi software tingkat perusahaan yang disesuaikan dengan kebutuhan bisnismu, mulai dari aplikasi desktop hingga sistem berbasis cloud.',
    ...
    },
    {
      ...
      title: 'UI/UX Design',
      description:
        'User-centered design that creates intuitive and engaging experiences, combining aesthetic appeal with functional usability.',
    ...
    },
    {
      ...
      description:
        'Comprehensive digital transformation strategies that align technology solutions with your business objectives.',
      features: [
        'Business Analysis',
    ...
    },
    {
      ...
      description:
        'Ongoing technical support and maintenance services to ensure your applications stay secure, updated, and performing optimally.',
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#E6F2FF]/30 via-[#FAFAFA] to-[#E6F2FF]/50 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-bl from-[#0057B8]/15 to-primary/15 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Mulai dari ide hingga peluncuran, kami siap membantu bisnis kamu berkembang di dunia
            digital dengan layanan teknologi yang menyeluruh dan terpercaya.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="space-y-2 mb-6">
                {service.features.map((feature, featureIndex) => (
                  <div key={featureIndex} className="flex items-center text-sm text-gray-600">
                    <div className="w-2 h-2 bg-gradient-to-r from-primary to-[#0057B8] rounded-full mr-3"></div>
                    {feature}
                  </div>
                ))}
              </div>
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-[#0057B8]/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
            </div>
          ))}
        </div>
